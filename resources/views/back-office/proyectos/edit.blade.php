                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                                                        ...
                                                        @foreach($fotos as $foto)
                                                            <div class="col-xl-3">
                                                                ...
                                                                <div class="card-footer">
                                                                    <form action="/proyecto/img/eliminar/{{ $foto->idFoto }}" method="POST">
                                                                        @csrf
                            ...
                            <form action="{{ url('/proyecto/update/'.$proyecto->idProyecto) }}" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
...
<script src="https://cdn.jsdelivr.net/npm/summernote@0.8.18/dist/summernote.min.js"></script>
    ...
    <script type="text/javascript">
        function initMap() {
            var map;
            var latlng = new google.maps.LatLng( {{ $propiedad->latitud }} , {{ $propiedad->longitud }});
