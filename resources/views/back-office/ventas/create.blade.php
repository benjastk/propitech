        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Ingresar Contrato de arriendo</h4>
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Contratos de arriendo</a></li>
                                    <li class="breadcrumb-item active">Ingresar Contrato de arriendo</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <form action="{{ url('/contratos/store') }}" method="POST" enctype="multipart/form-data" >
                                {{ csrf_field() }}
