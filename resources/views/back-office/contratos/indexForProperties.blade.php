                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Lista de Contratos de arriendo - Propiedad {{ $propiedad->direccion }} {{ $propiedad->numero }}</h4>
                            ...
                            <div class="page-title-right">
                                ...
                                <a href="/contratos/create?propiedad={{ $propiedad->id }}" class="btn btn-info waves-effect waves-light" style="margin-right: 10px">
