<html>
    ...
    <body style="text-align: justify;">
        ...
        <main>
            ...
            <p>En Santiago de Chile, a { fecha de mandato }, { nombre y apellido de propietario} , de nacionalidad { nacionalidad de propietario}, estado civil 
            { estado civil de propietario}, de profesi&oacute;n { profesion de propietario }, 
            C&eacute;dula de identidad N&deg; { rut de propietario }, correo <a href="mailto:">
            { correo de propietario },</a> con domicilio en { direccion de propietario }, 
            comuna de { comuna donde reside propietario }, Regi&oacute;n { region donde reside propietario}, en adelante
            &ldquo;<strong>El MANDANTE&rdquo;</strong>; 
            ...
            encuentra ubicada en <strong>{ direccion de la propiedad } dpto. 
            { numero de departamento } </strong>, comuna de <strong>{ comuna de propiedad}</strong>, Regi&oacute;n 
            { region de propiedad }., rol de aval&uacute;o fiscal n&uacute;mero { rol de la propiedad}.</p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <p><strong><u>SEGUNDO:</u></strong><strong> DURACI&Oacute;N DEL MANDATO.</strong></p>
            <p>La duraci&oacute;n del presente mandato ser&aacute; a contar de <strong>{ fecha de inicio de mandato}</strong>, 
            hasta el <strong>{ fecha de termino de mandato }</strong>, pudiendo renovarse de forma &nbsp;t&aacute;cita, 
            ...
            conveniente para su buena conservaci&oacute;n y rentabilidad, previa autorizaci&oacute;n del propietario por escrito o v&iacute;a correo 
            ...
            <p>&nbsp;</p>
            <p><strong><u>Facultades Especiales (PLAN ROBLE)</u></strong>:</p>
            <p>&nbsp;</p>
            <ol>
            ...
            <li>Publicaci&oacute;n de la propiedad y de las im&aacute;genes obtenidas, en los principales medios, portales y redes sociales del 
            <strong>MANDATARIO</strong>;</li>
            <li>Mostrar la propiedad, en relaci&oacute;n los t&eacute;rminos que pacte con los clientes, seg&uacute;n lo estipulado en la letra A) 
            de la presente cl&aacute;usula;</li>
            <li>Realizar un an&aacute;lisis de Cr&eacute;dito Riguroso: a trav&eacute;s de la obtenci&oacute;n y an&aacute;lisis de Certificado 
            DICOM Platinum 360&ordm;;</li>
            <li>Gestionar los contratos de compraventa y arriendo en Notar&iacute;a, y en caso de ser necesario, de la inscripciones en el respectivo 
            Conservador de Bienes Ra&iacute;ces;</li>
            <li>Revisar semestralmente el estado de arriendo de la propiedad, realizando un seguimiento de los pagos de las rentas de arriendo, 
            gastos comunes, servicios b&aacute;sicos y cualquier otro gasto especial pactado en el Contrato de Arriendo respectivo.</li>
            <li>Gestionar los da&ntilde;os en la(s) propiedad(es) individualizadas en la cl&aacute;usula primera del presente contrato, que incluye: 
            i) <strong>servicios de pintura</strong>: pintura al agua, solo con color blanco, incluye materiales; ii) <strong>servicios de 
            gasfiter&iacute;a</strong>: para remplazo de flexibles, reparaci&oacute;n de paso de agua y mantenimiento de inodoro (no incluye 
            materiales); iii) <strong>servicios de cerrajer&iacute;a</strong>: mantenimiento de puertas y ventanas (no incluye materiales); iv) 
            <strong>servicios de limpieza de alfombras</strong>: solo mano de obra, no incluye materiales; v) <strong>limpieza de piso flotante
            </strong>: solo mano de obra, no incluye materiales; vi) <strong>Cambio de vidrier&iacute;a en mal estado</strong>: solo mano de obra, 
            no incluye materiales; vii) <strong>Asesor&iacute;a para mantenci&oacute;n de aire acondicionado</strong>: no incluye valores de 
            mantenci&oacute;n ni cambio en todo o parte del aire acondicionado.</li>
            <li>Gestionar legalmente el contrato de arriendo, otorgando al <strong>MANDANTE</strong> una reuni&oacute;n de soluci&oacute;n de dudas 
            con un Abogado especialista en materias civiles.</li>
            </ol>
            <p>&nbsp;</p>
            <p><strong><u>CUARTO:</u></strong><strong> REMUNERACI&Oacute;N.</strong></p>
            <p>&nbsp;</p>
            <p>El<strong> MANDATARIO </strong>ser&aacute; remunerado por la ejecuci&oacute;n de este mandato. Para esto efectos el<strong> 
            MANDANTE</strong>, pagar&aacute; a el<strong> MANDATARIO</strong>, la siguiente remuneraci&oacute;n:</p>
            <p>&nbsp;</p>
            <ol>
            <li><strong>Comisi&oacute;n de Corretaje</strong>: un <strong>pago &uacute;nico</strong> por un  { porcentaje de comision por corretaje } por ciento del monto de un 
            mes de arriendo, m&aacute;s IVA;</li>
            <li><strong>Comisi&oacute;n por Administraci&oacute;n</strong>: <strong>pagos mensuales</strong> de un { porcentaje de administracion mensual de la propiedad} por ciento 
            ...
            <p>&nbsp;</p>
            <p>El pago de la remuneraci&oacute;n se efectuar&aacute; al<strong> MANDANTE </strong>dentro de los <strong>{ dia en palabras de la fecha de pago mensual donde se realizará 
            el pago del arriendo al propiertario} primeros d&iacute;as 
            ...
            <strong>{ numero de cuenta bancaria de propietario}</strong>, del Banco <strong>{ banco donde se debe enviar los fondos al propietario }</strong>, mail 
            <a href="mailto:"><strong>{ correo electronico de propietario }</strong>,</a> 
            Rut., <strong>{ rut de propietario }</strong>.-</p>
            <p style="page-break-after: always;">
            ...
            <p>Las partes declaran que para todos los efectos legales derivados de este contrato fijan su domicilio en la comuna y ciudad de 
            Santiago, otorgando competencia a los respectivos Tribunales Civiles.</p>
            <p>&nbsp;</p>
            ...
            <ul>
            <li>Domicilio: { direccion propietario }, Comuna de {comuna donde reside propietario}, Región
                {region donde reside propietario }.</li>
            <li>N&uacute;mero de Tel&eacute;fono: +56 { telefono de contacto de propietario}</li>
            <li>Correo Electr&oacute;nico: <a href="mailto:">{ correo electronico de propietario}</a></li>
            </ul>
            <ol>
            ...
            <p>En caso de que cualquiera de las partes cambie su domicilio, tel&eacute;fono y/o correo indicado en la presente cl&aacute;usula 
            durante la vigencia del presente contrato de mandato, deber&aacute; notificar formalmente y por escrito a la otra de dicha 
            modificaci&oacute;n. En caso contrario, se entender&aacute; como correcta la notificaci&oacute;n y/o comunicaci&oacute;n que se realice, 
            liberando de cualquier responsabilidad que se genere por la incorrecta notificaci&oacute;n.</p>
            <p><strong>&nbsp;</strong></p>
            <p style="page-break-after: always;">
            <p><strong><u>NOVENO</u></strong><strong>: DECLARACI&Oacute;N.</strong></p>
            <p>El <strong>MANDANTE</strong> declara haber le&iacute;do los T&eacute;rminos y Condiciones y Pol&iacute;ticas de Privacidad 
            contenidas en la p&aacute;gina web <a href="http://www.propitech.cl">www.propitech.cl</a>, y estar de acuerdo con cada una de las 
            cl&aacute;usulas contenidas en ellas.</p>
            <p>&nbsp;</p>
            <p><strong><u>D&Eacute;CIMO</u></strong><strong>: RENDICI&Oacute;N DE CUENTAS</strong>.</p>
            <p>El <strong>MANDANTE</strong> declara expresamente liberar al <strong>MANDATARIO</strong> de rendir cuentas del presente mandato y sus sucesivas renovaciones.</p>
            <p><strong>&nbsp;</strong></p>
            <p><strong><u>D&Eacute;CIMO PRIMERO</u></strong><strong>: PERSONER&Iacute;A</strong>. La personer&iacute;a de don <strong>GUSTAVO ENRIQUE CISTERNAS P&Eacute;REZ</strong>, para actuar en representaci&oacute;n de la sociedad <strong>INVERSIONES Y SERVICIOS PROFESIONALES B&amp;C SpA</strong>, consta en <strong>Certificado de Estatutos Actualizados</strong> del Registro de Empresas y Sociedades del Ministerio de Econom&iacute;a, Fomento y Turismo. El certificado no se inserta, a ruego de las partes por ser consideradas por &eacute;stas y del Notario que autoriza.</p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <table>
            ...
            <p style="text-align: center;"><strong> { nombre de propietario } </strong></p>
            <p style="text-align: center;"><strong>&nbsp;C.I. N&ordm; { rut propietario }</strong></p>
            <p><strong>&nbsp;</strong></p>
            <p><strong>&nbsp;</strong></p>
            <p><strong>&nbsp;</strong></p>
            <p><strong>&nbsp;</strong></p>
