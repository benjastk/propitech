<html>
    ...
    <body style="text-align: justify;">
        ...
        <main>
            ...
            de identidad N&deg; {{ $mandatoAdministracion->rutPropietario }}, correo <a href="mailto:{{ $mandatoAdministracion->correoPropietario }}">
            ...
            <p>&nbsp;</p>
            <ol>
            <li><strong>Comisi&oacute;n por Administraci&oacute;n</strong>: <strong>pagos mensuales</strong> de un cinco coma cinco por ciento 
