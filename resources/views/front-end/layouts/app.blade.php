<!doctype html>
    ...
    <head>
        ...
        rel="stylesheet">
        <!-- Vendors CSS -->
        <link rel="stylesheet" href="/front/vendors/fontawesome-pro-5/css/all.css">
        <link rel="stylesheet" href="/front/vendors/bootstrap-select/css/bootstrap-select.min.css">
        <link rel="stylesheet" href="/front/vendors/slick/slick.min.css">
        <link rel="stylesheet" href="/front/vendors/magnific-popup/magnific-popup.min.css">
        <link rel="stylesheet" href="/front/vendors/jquery-ui/jquery-ui.min.css">
        <link rel="stylesheet" href="/front/vendors/chartjs/Chart.min.css">
        <link rel="stylesheet" href="/front/vendors/dropzone/css/dropzone.min.css">
        ...
        fbq('init', '1532355460930286');
        fbq('track', 'PageView');
        </script>
        <noscript><img height="1" width="1" style="display:none"
        src="https://www.facebook.com/tr?id=1532355460930286&ev=PageView&noscript=1"
        /></noscript>
        <!-- End Meta Pixel Code -->
        <style>
            .bg-secondary
    ...
    <body>
            ...
            <div class="container">
                ...
                <ul class="navbar-nav hover-menu main-menu px-0 mx-lg-n4">
                    ...
                    <li id="navbar-item-dashboard" aria-haspopup="true" aria-expanded="false" class="nav-item dropdown py-2 py-lg-5 px-0 px-lg-4">
                        ...
                        <ul class="dropdown-menu pt-3 pb-0 pb-lg-3" aria-labelledby="navbar-item-dashboard">
                            <li class="dropdown-item">
                                <a id="navbar-link-dashboard" class="dropdown-link" href="/servicios-administracion-propiedades" >
                                    Nuestros servicios
                                </a>
                            </li>
                            <li class="dropdown-item">
                                <a id="navbar-link-dashboard" class="dropdown-link" href="/publica-tu-propiedad" >
                    ...
                    <li id="navbar-item-pages" aria-haspopup="true" aria-expanded="false" class="nav-item dropdown py-2 py-lg-5 px-0 px-lg-4">
                        ...
                        <ul class="dropdown-menu pt-3 pb-0 pb-lg-3" aria-labelledby="navbar-item-dashboard">
                            <li class="dropdown-item">
                                <a id="navbar-link-dashboard" class="dropdown-link" href="/nosotros" >
                                    Quienes somos
                                </a>
                            </li>
                            <li class="dropdown-item">
                                <a id="navbar-link-dashboard" class="dropdown-link" href="/trabaja-con-nosotros" >
                                    Trabaja con nosotros
                                </a>
                            </li>
                            <li class="dropdown-item">
                                <a id="navbar-link-dashboard" class="dropdown-link" href="/preguntas-frecuentes" >
                                    Preguntas frecuentes
                                </a>
                            </li>
                            <li class="dropdown-item">
                                <a id="navbar-link-dashboard" class="dropdown-link" href="/terminos-condiciones" >
                    ...
                    <li id="navbar-item-dashboard" aria-haspopup="true" aria-expanded="false" class="nav-item dropdown py-2 py-lg-5 px-0 px-lg-4">
                        <a class="btn btn-success" href="#" style="background-color: #d57a49; font-weight: 700; box-shadow: 2px 2px 2px 1px rgb(0 0 0 / 30%)">
                            ¡Invierte Aquí!
                            <span class="caret"></span>
                        </a>
                    </li>
        ...
        <footer class="bg-dark pt-8 pb-6 footer text-muted">
            <div class="container">
                ...
                <div class="col-md-6 col-lg-4 mb-6 mb-md-0">
                    ...
                    <img src="/front/02.svg" style="height: 68px" alt="PROPITECH">
                    </a>
                ...
                <div class="col-md-6 col-lg-4 mb-6 mb-md-0">
                    <h4 class="text-white fs-16 my-4 font-weight-500">Suscribete a nuestras noticias</h4>
                    <p class="font-weight-500 text-muted lh-184">Ingresa tu correo electronico</p>
        ...
        <!-- Vendors scripts -->
        <script src="/front/vendors/jquery.min.js"></script>
        <script src="/front/vendors/jquery-ui/jquery-ui.min.js"></script>
        <script src="/front/vendors/bootstrap/bootstrap.bundle.js"></script>
        <script src="/front/vendors/bootstrap-select/js/bootstrap-select.min.js"></script>
        <script src="/front/vendors/slick/slick.min.js"></script>
        <script src="/front/vendors/waypoints/jquery.waypoints.min.js"></script>
        <script src="/front/vendors/counter/countUp.js"></script>
        <script src="/front/vendors/magnific-popup/jquery.magnific-popup.min.js"></script>
        <script src="/front/vendors/chartjs/Chart.min.js"></script>
        <script src="/front/vendors/dropzone/js/dropzone.min.js"></script>
        <script src="/front/vendors/timepicker/bootstrap-timepicker.min.js"></script>
        <script src="/front/vendors/hc-sticky/hc-sticky.min.js"></script>
        <script src="/front/vendors/jparallax/TweenMax.min.js"></script>
        <script src="/front/vendors/mapbox-gl/mapbox-gl.js"></script>
        <script>
                ...
                $("#region").change(function(){
                    ...
                    $.ajax({
                        ...
                        success : function(respuesta){
                            ...
                            $("#comuna").html(select_comuna);
                        }
                    });
                });
                $("#regionMobile").change(function(){
                    var idRegion = $("#regionMobile").val();          
                    $.ajax({
                        type: "GET",
                        url : "{{url('api/getComunaRegion')}}",
                        headers: {
                        ...
                        success : function(respuesta){
                            ...
                            $("#comunaMobile").html(select_comuna);
                        }
                    });
                });
            });
        ...
        <script>
            $('#venta').click(function() {
                if($('#venta').is(':checked'))
                { 
                    $('#botonVenta').css('background-color', 'white');
                    $('#botonVenta').css('color', '#2db5ff');
                    $('#botonVenta').css('border-color', '#2db5ff');
                    $('#botonArriendo').css('background-color', '#2db5ff');
                    $('#botonArriendo').css('color', 'white');
                }
            });
            $('#arriendo').click(function() {
                if($('#arriendo').is(':checked'))
                { 
                    $('#botonArriendo').css('background-color', 'white');
                    $('#botonArriendo').css('color', '#2db5ff');
                    $('#botonArriendo').css('border-color', '#2db5ff');
                    $('#botonVenta').css('background-color', '#2db5ff');
                    $('#botonVenta').css('color', 'white');
                }
            });
            $('#venta1').click(function() {
                if($('#venta1').is(':checked'))
                { 
                    $('#botonVenta1').css('background-color', 'white');
                    $('#botonVenta1').css('color', '#2db5ff');
                    $('#botonVenta1').css('border-color', '#2db5ff');
                    $('#botonArriendo1').css('background-color', '#2db5ff');
                    $('#botonArriendo1').css('color', 'white');
                }
            });
            $('#arriendo1').click(function() {
                if($('#arriendo1').is(':checked'))
                { 
                    $('#botonArriendo1').css('background-color', 'white');
                    $('#botonArriendo1').css('color', '#2db5ff');
                    $('#botonArriendo1').css('border-color', '#2db5ff');
                    $('#botonVenta1').css('background-color', '#2db5ff');
                    $('#botonVenta1').css('color', 'white');
                }
            });
        </script>
        @yield('jss')
