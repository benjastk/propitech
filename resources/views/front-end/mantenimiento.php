...
<html lang="en">
    ...
    <body>
        <div class="home-btn d-none d-sm-block">
            <a href="/inicio" class="text-white"><i class="fas fa-home h2"></i></a>
        </div>
        <div class="pt-sm-5">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            ...
                            <h4 class="mt-5">Sitio web en construccion</h4>
                            <p class="text-muted">Estamos trabajando para entregarte una experiencia unica.</p>
                            <a class="btn btn-dark waves-effect waves-light" href="/login">Iniciar Sesion</a>
                            <div class="row justify-content-center mt-5">
                                <div class="col-md-8">
                                    <div data-countdown="2023/07/24" class="counter-number"></div>
                                </div> <!-- end col-->
                            </div> <!-- end row-->
                        </div>
                    </div>
