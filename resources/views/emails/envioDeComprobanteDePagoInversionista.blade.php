...
@section('content')
    <table style="border-collapse:collapse;margin: auto !important;" cellspacing="0">
        <tr style="height:32pt">
            <td colspan="2">
                <p class="s1" style="padding-left: 22pt;text-indent: 0pt;line-height: 17pt;text-align: left;">Estimado {{ $informacion->nombre }} {{ $informacion->apellido }}</p>
            </td>
        </tr>
        <tr style="height:95pt">
            <td>
                ...
                <p class="s2" style="padding-left: 26pt;text-indent: 0pt;text-align: left;">Junto con saludar, adjunto podra encontrar la Liquidación de Pago a Propietario 
                de la propiedad ubicada en {{ $informacion->direccion }} {{ $informacion->numero }} 
    ...
    <!--<table style="border-collapse:collapse; width: 100%; margin:auto !important" cellspacing="0">
        <tr style="height:25pt">
            <td>
                <p class="s5" style="padding-top: 7pt;padding-left: 26pt;text-indent: 0pt;line-height: 17pt;text-align: left;">Valor Reserva</p>
            </td>
            <td>
                <p class="s6" style="padding-top: 7pt;padding-left: 4pt;text-indent: 0pt;line-height: 17pt;text-align: left;">$ {{ number_format($informacion->valorReserva, 0, '', '.')}}</p>
            </td>
        </tr>
        <tr style="height:33pt">
            ...
            <td >
                <p class="s8" style="padding-top: 6pt;padding-left: 4pt;text-indent: 0pt;text-align: left;">$ {{ number_format($informacion->valorReserva, 0, '', '.')}}</p>
            </td>
        </tr>
    </table>-->
    <table style="border-collapse:collapse;margin: auto !important" cellspacing="0">
        <tr style="height:77pt">
            <td colspan="2">
                <p class="s3" style="padding-top: 5pt;padding-left: 7pt;text-indent: 0pt;text-align: left;">
                    <span class="s9">☝</span>En caso de tener alguna duda con su pago, favor comunicarse a su ejecutivo de administración.
                </p>    
            </td>
        </tr>
