...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        $mes = date("m");
        $anio = date("Y");
        $schedule->call('App\Http\Controllers\EstadoPagoController@cambiarAMoroso')->dailyAt('10:35');
        $schedule->call('App\Http\Controllers\EstadoPagoController@cambiarAVencido')->dailyAt('10:35');
        $schedule->call('App\Http\Controllers\EstadoPagoController@agregarPorcentajeAMorosos')->dailyAt('10:35');
