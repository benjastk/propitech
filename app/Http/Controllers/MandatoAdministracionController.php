...
class MandatoAdministracionController extends Controller
{
    ...
    public function buscarPagosMandatosMes(Request $request)
    {
        ...
        $cargosPropietario = Cargo::whereIn('idEstadoPago', $idsEstadosPago)->get()->groupBy('idEstadoPago');
        $descuentosPropietario = Descuento::whereIn('idEstadoPago', $idsEstadosPago)->get()->groupBy('idEstadoPago');
